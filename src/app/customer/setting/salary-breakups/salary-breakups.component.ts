...
@Component({
  selector: 'app-salary-breakups',
  templateUrl: './salary-breakups.component.html',
  styleUrls: ['./salary-breakups.component.css']
})
export class SalaryBreakupsComponent implements OnInit {
